...
def solarPredict(state):
    # Load the dataset
    data = pd.read_excel(state)
    #print(data)
    # Drop irrelevant columns
    data.drop(['Name of State/UT', 'Biomass', 'Wind ', 'Small Hydro '], axis=1, inplace=True,errors='ignore')
    ...
    y_pred_ensemble = meta_model.predict(meta_X_test)
    print("Solar Prediction of 12 months of 2024")
